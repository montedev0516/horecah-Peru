<template>
    <div class="flex h-screen">
        <div class="sidebar w-100 bg-[#011c3e]" style="min-width: 500px">
            ...
            <div class="flex-col row-span-3 m-2 bg-[#00326d] bg-opacity-90 rounded-lg">
                <div class="flex p-5">
                ...
                <div class="pb-7 mx-2">
                    <div class="input-group">
                        <input type="text" placeholder="Search list or Input Phonenumbers" class="input-field rounded-lg"
