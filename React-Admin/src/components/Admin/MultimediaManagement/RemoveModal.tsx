...
const RemoveModal = ({removeId, isOpenRemove, setIsOpenRemove, setData}:props) => {
  ...
  const handleRemove = async () => {
    ...
    await myAxios.post("/admin/deletemultimedia", { id: removeId }).then((res) => {
      ...
      if(res.data) {
        ...
        setData(updatedData);
        toastr.success("Multimedia removed successfully");
      }
    }).catch(() => {
      ...
      >
        <div className="my-10 mx-5">
          <div className="mb-10 text-xl">
            Are you sure you wish to remove this multimedia?
          </div>
